...
public class PersonaController {
    ...
    @FXML
    private TableColumn<Persona, String> colClase;
    @FXML
    ...
    @FXML
    private ComboBox<String> tfClase;
    ...
    public void initialize() {
        ...
        tfClase.getItems().add("Turista");
        tfClase.getItems().add("Ejecutiva");
    }
    ...
    public void onGuardarClick() {
        try {
            ...
            colFecha.setText(String.valueOf(tfFecha.getValue()));
            colClase.setText(tfClase.getValue());
            llenarTabla(INSTANCE.getBus().buscar(null, null, null));
            limpiarCampos();
